...
#include "ChatCrab.h"
#include "string"
#include <stdio.h>//?? позже посмотрю
#include<vector>
#include<string>

using namespace std;

void login();//объвление для видимости
...
void Chat::registration_in_the_chat() {//регестрация
	...
	cout << "size(AllUsers_)количество пользователей " << size(AllUsers_) << std::endl;//строка отладки AllUsers_ будет удалина
	}
